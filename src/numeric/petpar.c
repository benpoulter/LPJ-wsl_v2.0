...
Real petpar(Real *daylength, /* daylength (h) */
            ...
            Real sun)        /* sunshine (%) */
{
  ...
  return(rs_day/dayseconds);  //return SW in W/m2
} /* of 'petpar' */
